...
public class MyService extends Service implements SpeechDelegate, Speech.stopDueToDelay {
  ...
  public void onSpeechResult(String result) {
    ...
    if (!TextUtils.isEmpty(result)) {
      Toast.makeText(this, "Your speech:"+result, Toast.LENGTH_SHORT).show();
      
      
      if(result.contains("unlock")||result.contains("bacao")){
          ...
          Toast.makeText(this, "Not deetct", Toast.LENGTH_SHORT).show();
      }
